(()=>{
 const AI_KEY='businessai-ai-history',AUTOPLAN_KEY='businessai-ai-autoplan',PROJECTS_KEY='businessai-projects-v1',AUTOPLAN_HISTORY_KEY='businessai-autoplan-history-v1',AUTOPLAN_PROGRESS_KEY='businessai-autoplan-progress-v1',WEEKLY_COACH_KEY='businessai-weekly-coach-v1';
 ...
 const statusText=()=>lang()==='uk'?'Повну копію з проєктами, AI, прогресом Автоплану та Weekly Coach підготовлено':lang()==='en'?'Full backup with projects, AI, Autoplan progress and Weekly Coach prepared':'Úplná záloha s projektmi, AI, progresom Autoplánu a Weekly Coach je pripravená';
