(()=>{
 const AI_KEY='businessai-ai-history',AUTOPLAN_KEY='businessai-ai-autoplan',PROJECTS_KEY='businessai-projects-v1',AUTOPLAN_HISTORY_KEY='businessai-autoplan-history-v1',AUTOPLAN_PROGRESS_KEY='businessai-autoplan-progress-v1',WEEKLY_COACH_KEY='businessai-weekly-coach-v1',WEEKLY_SNAPSHOTS_KEY='businessai-weekly-snapshots-v1';
 ...
 const statusText=()=>lang()==='uk'?'Повну копію з проєктами, AI, Weekly Coach та історією тижнів підготовлено':lang()==='en'?'Full backup with projects, AI, Weekly Coach and weekly history prepared':'Úplná záloha s projektmi, AI, Weekly Coach a históriou týždňov je pripravená';
 ...
 const makeBackup=()=>({
  ...
  weeklyCoach:read(WEEKLY_COACH_KEY,'{"version":1,"byProject":{}}'),
  weeklySnapshots:read(WEEKLY_SNAPSHOTS_KEY,'{"version":1,"byProject":{}}'),
